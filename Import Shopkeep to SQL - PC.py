...
shopkeep_file = "pearmund_transaction_items_oneyeardata.xlsx"
...
transaction_items_oct = pd.read_excel('pearmund_20231001-20231031-transaction-items.xlsx')
transaction_items_nov = pd.read_excel('pearmund_20231101-20231130-transaction-items.xlsx')
transaction_items_dec = pd.read_excel('pearmund_20231201-20231231-transaction-items.xlsx')
sales_by_customer_oct = pd.read_excel('pearmund_sales_by_customer_from_2023-10-01_to_2023-10-31.xlsx')
sales_by_customer_nov = pd.read_excel('pearmund_sales_by_customer_from_2023-11-01_to_2023-11-30.xlsx')
sales_by_customer_dec = pd.read_excel('pearmund_sales_by_customer_from_2023-12-01_to_2023-12-31.xlsx')
club_members = pd.read_excel('PC Members.xlsx')


# In[6]:

pc_wine_club_emails = club_members[club_members['Club Name'] == 'pearmund Wine Club']['Bill Email']
...
#sales_master_jan = sales_master_jan[sales_master_jan['CustomerClass'] == 'pearmund Wine Club']
#sales_master_feb = sales_master_feb[sales_master_feb['CustomerClass'] == 'pearmund Wine Club']
...
final_data.to_sql('shopkeep_revenue_pc', con=engine, if_exists='replace', index=False)
shopkeep.to_sql('shopkeep_items_pc', con=engine, if_exists='replace', index=False)